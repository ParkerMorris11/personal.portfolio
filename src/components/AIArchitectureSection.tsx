        ...
        <div className="flex flex-col md:flex-row items-center flex-1 w-full">
          <div className="flex flex-col items-center flex-1 w-full">
            <div className="w-full rounded-xl border border-black/10 dark:border-white/10 bg-black/[0.03] dark:bg-white/[0.03] p-4 text-center hover:border-black/20 dark:hover:border-white/20 hover:bg-black/[0.06] dark:bg-white/[0.06] transition-all duration-300">
              ...
              <p className="text-gray-900/35 dark:text-white/35 text-xs leading-relaxed">{step.detail}</p>
            </div>
          </div>
          {i < steps.length - 1 && (
    ...
    <section id="architecture" className="relative py-32 px-4 bg-white dark:bg-black">
      <div className="max-w-5xl mx-auto">
        ...
        >
          Designing systems,
          <br />
          <span className="text-gray-900/50 dark:text-white/50">not just writing code</span>
        </motion.h2>
        <motion.p
          {...fadeUp}
          transition={{ ...fadeUp.transition, delay: 0.2 }}
          className="text-lg text-gray-900/40 dark:text-white/40 leading-relaxed max-w-2xl mb-16"
        >
        ...
        >
          <div className="flex items-center justify-between mb-8 flex-wrap gap-4">
            <div>
              <p className="text-xs text-gray-900/30 dark:text-white/30 tracking-widest uppercase mb-2">Case Study</p>
              <h3 className="text-2xl font-semibold text-white">Bronz Bliss — Tanning Studio CRM</h3>
              <p className="text-gray-900/40 dark:text-white/40 text-sm mt-1">React · Node.js · Express · Drizzle ORM · Vercel</p>
            </div>
          ...
          <div className="border-t border-black/10 dark:border-white/10 pt-8 grid md:grid-cols-3 gap-8">
            <div>
              <p className="text-xs text-gray-900/30 dark:text-white/30 tracking-widest uppercase mb-3">The Problem</p>
            ...
            <div>
              <p className="text-xs text-gray-900/30 dark:text-white/30 tracking-widest uppercase mb-3">The Design</p>
              <p className="text-gray-900/50 dark:text-white/50 text-sm leading-relaxed">
            ...
            <div>
              <p className="text-xs text-gray-900/30 dark:text-white/30 tracking-widest uppercase mb-3">Strategic Layer</p>
              <p className="text-gray-900/50 dark:text-white/50 text-sm leading-relaxed">
        ...
        >
          <div className="flex items-center justify-between mb-8 flex-wrap gap-4">
            <div>
              ...
              <p className="text-gray-900/40 dark:text-white/40 text-sm mt-1">Python · Automation · Scheduled Agent</p>
            </div>
