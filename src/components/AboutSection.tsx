    ...
    <section id="about" className="relative py-32 px-4 bg-white dark:bg-black">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <br />
          <span className="text-gray-900/75 dark:text-white/50">what exists and what should</span>
        </motion.h2>
        <motion.p
          {...fadeUp}
        ...
        <motion.div
          ...
          className="mt-4"
        >
          <p className="text-xs text-gray-900/80 dark:text-white/30 tracking-widest uppercase mb-4">Experience</p>
          <div className="flex flex-col gap-3">
            <div className="rounded-2xl border border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02] p-6 flex items-center justify-between gap-6">
              <div>
                <p className="text-gray-900 dark:text-white font-semibold text-lg">IT Specialist</p>
                <p className="text-gray-900/75 dark:text-white/50 text-sm mt-1">BYU J. Reuben Clark Law School</p>
                <p className="text-gray-900/70 dark:text-white/40 text-sm mt-1">Provo, UT</p>
              </div>
              <div className="text-right shrink-0">
                <p className="text-gray-900/80 dark:text-white/30 text-xs tracking-widest uppercase">Current</p>
            ...
            <div className="rounded-2xl border border-black/10 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.02] p-6 flex items-center justify-between gap-6">
              <div>
                ...
                <p className="text-gray-900/75 dark:text-white/50 text-sm mt-1">The Church of Jesus Christ of Latter-day Saints</p>
                <p className="text-gray-900/70 dark:text-white/40 text-sm mt-1">Lubbock, TX</p>
              </div>
              <div className="text-right shrink-0">
